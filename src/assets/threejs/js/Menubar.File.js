...
import { zipSync, strToU8 } from '@/assets/threejs/jsm/libs/fflate.module.js';
...
function MenubarFile( editor ) {
	...
	option.onClick( async function () {
		...
		const { ColladaExporter } = await import( '@/assets/threejs/jsm/exporters/ColladaExporter.js' );
	...
	option.onClick( async function () {
		...
		const { DRACOExporter } = await import( '@/assets/threejs/jsm/exporters/DRACOExporter.js' );
	...
	option.onClick( async function () {
		...
		const { GLTFExporter } = await import( '@/assets/threejs/jsm/exporters/GLTFExporter.js' );
	...
	option.onClick( async function () {
		...
		const { OBJExporter } = await import( '@/assets/threejs/jsm/exporters/OBJExporter.js' );
	...
	option.onClick( async function () {
		...
		const { PLYExporter } = await import( '@/assets/threejs/jsm/exporters/PLYExporter.js' );
	...
	option.onClick( async function () {
		...
		const { STLExporter } = await import( '@/assets/threejs/jsm/exporters/STLExporter.js' );
	...
	option.onClick( async function () {
		...
		const { USDZExporter } = await import( '@/assets/threejs/jsm/exporters/USDZExporter.js' );
